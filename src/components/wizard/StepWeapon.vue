  ...
  <div class="panel">
    ...
    <div class="info-box">
      <template v-if="w">
        ...
        <p><i>Скрытое ношение:</i> {{ w.stealth }}<template v-if="w.concealable"> — ваш бросок d20 {{ fmt(rules.stealthRoll()) }}{{ rules.stealthAdvNote() }}.</template><template v-else>.</template>
